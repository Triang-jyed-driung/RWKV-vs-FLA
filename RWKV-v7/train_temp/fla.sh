...
#
python -X faulthandler train.py --load_model "0" --wandb "align_fla" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 ...
 --fla_dir /home/ruichongzhang/RWKV-LM/RWKV-v7/train_temp/fla_model --train_type fla
